...
-- Dummy inserts for uni_tasks.assignment
INSERT INTO uni_tasks.assignment (grade, date, usr_id, cl_id) VALUES
    (85.5, '2023-02-15', 1, 1),
    (75.0, '2023-03-01', 2, 2),
    (92.5, '2023-02-25', 3, 3),
    ...
    (81.0, '2023-03-03', 8, 8),
    (89.5, '2023-02-28', 9, 9),
    (78.0, '2023-03-08', 10, 10),
    (94.5, '2023-02-16', 11, 11),
    (82.0, '2023-03-01', 12, 12),
    (90.5, '2023-02-23', 13, 13),
    (79.0, '2023-03-06', 14, 14),
    (95.5, '2023-02-21', 15, 15),
    (83.0, '2023-02-27', 16, 16),
    (91.5, '2023-02-17', 17, 17),
    (80.0, '2023-03-04', 18, 18),
    (96.5, '2023-02-19', 19, 19),
    (84.0, '2023-03-02', 20, 20),
    (92.5, '2023-02-24', 21, 21),
    (81.0, '2023-03-09', 22, 22),
    (97.5, '2023-02-22', 23, 23),
    (85.0, '2023-02-28', 24, 24),
    (93.5, '2023-02-26', 25, 25),
    (82.0, '2023-03-07', 26, 26),
    (98.5, '2023-02-20', 27, 27),
    (86.0, '2023-03-05', 28, 28),
    (94.5, '2023-02-23', 29, 29),
    (83.0, '2023-03-02', 30, 30),
    (99.5, '2023-02-18', 31, 31),
    (87.0, '2023-03-01', 32, 32),
    (95.5, '2023-02-25', 33, 33),
    (84.0, '2023-03-08', 34, 34),
    (100.0, '2023-02-16', 35, 35),
    (88.0, '2023-02-27', 36, 36),
    (96.5, '2023-03-06', 37, 37),
    (85.0, '2023-03-03', 38, 38),
    (101.0, '2023-02-21', 39, 39),
    (89.0, '2023-02-28', 40, 40),
    (97.5, '2023-02-26', 41, 41),
    (86.0, '2023-03-07', 42, 42),
    (102.0, '2023-02-19', 43, 43),
    (90.0, '2023-03-04', 44, 44),
    (98.5, '2023-02-24', 45, 45),
    (87.0, '2023-03-09', 46, 46),
    (103.0, '2023-02-22', 47, 47),
    (91.0, '2023-03-01', 48, 48),
    (99.5, '2023-02-23', 49, 49),
    (88.0, '2023-03-08', 50, 50);
