...
```
Produtos: codigo, nome, prazo, IVA

Armazém: codigo, morada

Encomenda: numero, data, fornecedor, produto(s) 

Condição Pagamento: código, designação, prazo

Fornecedor: código, nome, NIF, endereço, FAX, condição pagamento, tipo fornecedor
...
```
Armazém - Produtos (1 - N) (Obrigatoriedade: Produtos)

Produtos - Encomenda (1..N - N) (Obrigatoriedade: Encomenda)

Encomenda - Fornecedor (N - 1) (Obrigatoriedade: Encomenda)

Fornecedor - Tipo de Fornecedor (N - 1) (Obrigatoriedade: Fornecedor)

Fornecedor - Condição de Pagamento (N - 1) (Obrigatoriedade: Fornecedor)

Todas as relações têm grau 2
